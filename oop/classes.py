...
"========Atributy klassa========"
# Atributy klassa - eto peremennye vnutri klassa 

"=========Mertody klassa======"
# metody klassa - funkciya vnutri klassa

"===========Obiekty klassa========"
# obiekt,exzemplyar, instance klassa - obiekt sozdannyu po wablonu klassa (on perenimaetvse attributy i metody u klassa)

"=========Attributy i metody obiekta==========="
# attributy i metody, kotorye est u obiekta, no vozmojno ih net u klassa

class A:
    var1 = "peremennyaya obiekta"

    def __init__(self):
        self.var2 = "peremennyaya klassa"
